...
export const MANAGERS: Manager[] = [
  { name: "이도현", dept: "생산/설비관리팀" },
  { name: "이재준", dept: "생산/설비관리팀" },
  { name: "김승정", dept: "생산/설비관리팀" },
  { name: "신동호", dept: "생산/설비관리팀" },
  { name: "노대균", dept: "생산/설비관리팀" },
  { name: "박경호", dept: "생산/설비관리팀" },
  { name: "노영준", dept: "생산/설비관리팀" },
  { name: "김지훈", dept: "생산/설비관리팀" },
  { name: "배상식", dept: "생산/설비관리팀" },
  { name: "박병후", dept: "생산/설비관리팀" },

    ...
    jsa: [
      {
        ...
        reduction: "1. 작업구역 라인테이프·표지판 설치 및 통제\n2. 작업 전 TBM(위험예지) 실시\n3. 누전차단기 연결·손상 공구 사용금지",
      },
    ],
  ...
  },
  {
    ...
    data: {
      ...
      jsa: [{
        ...
        reduction: "1. 화재감시자 배치, 작업 후 30분 잔불 확인\n2. 국소배기·강제환기 실시\n3. 방열장갑·보안면 착용, 고온부 표시",
      }],
    },
  },
  {
    ...
    data: {
      ...
      jsa: [{
        ...
        current: "1. 안전대 체결\n2. 안전난간·방망 설치\n3. 발판 고정상태 확인",
        reduction: "1. 안전대 부착설비(생명줄) 설치·체결 확인\n2. 하부 출입통제, 공구 낙하방지끈 사용\n3. 발판 고정상태 수시 점검",
      }],
    },
  },
  {
    ...
    data: {
      ...
      jsa: [{
        ...
        reduction: "1. 적정공기 확인 후 출입(산소 18~23.5%)\n2. 작업 중 연속 환기·연속 측정\n3. 구조장비 비치, 출입대장 작성",
      }],
    },
  },
  {
    ...
    data: {
      ...
      jsa: [{
        ...
        reduction: "1. 차단표지 부착, 담당자 외 조작금지\n2. 아크방지 보호구 착용, 방호벽 설치\n3. 단선도 확인, 2인 상호확인",
      }],
    },
  },
  {
    ...
    data: {
      ...
      jsa: [{
        ...
        frequency: 2, severity: 4,
        current: "1. 신호수 배치\n2. 작업반경 출입통제\n3. 노면·자격 확인",
        reduction: "1. 유도자 신호 준수, 작업반경 접근금지\n2. 아웃트리거 설치, 지반 다짐 확인\n3. 정격하중 준수, 줄걸이 상태 점검",
      }],
    },
  },
  {
    ...
    data: {
      ...
      jsa: [{
        ...
        frequency: 2, severity: 4,
        current: "1. 흙막이·구배 확보\n2. 매설물 사전확인\n3. 작업반경 통제",
        reduction: "1. 굴착면 수시 점검, 우천 시 작업중지\n2. 관리기관 입회·시험굴착 실시\n3. 유도자 배치, 장비-근로자 이격거리 확보",
      }],
    },
  },
  {
    ...
    data: {
      ...
      jsa: [{
        ...
        reduction: "1. 유자격자 작업, 이격거리·차폐 확보\n2. 작업구역 격리·경계로프·감시자 배치\n3. 선원 관리대장 기록, 작업 전후 선원 수량 확인",
      }],
    },
  },
];
